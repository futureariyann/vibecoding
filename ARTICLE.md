...
*   🎨 **Frontend:** **Kimi k2.5** (The Visualist) - "Sees" Figma, outputs Tailwind.
*   ⚙️ **Logic:** **Claude 3.7 Sonnet** (The Logician) - Lowest hallucination rate.
*   🏗️ **Refactoring:** **Gemini 3 Pro** (The Librarian) - Infinite context window.
*   ⚡ **Quick Fixes:** **Llama 4** (The Sprinter) - <100ms latency.
